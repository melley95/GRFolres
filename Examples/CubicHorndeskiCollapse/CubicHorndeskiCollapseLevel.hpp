...
#ifndef CUBICHORNDESKICOLLAPSELEVEL_HPP_
#define CUBICHORNDESKICOLLAPSELEVEL_HPP_
...
class CubicHorndeskiCollapseLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<CubicHorndeskiCollapseLevel>;
...
#endif /* CUBICHORNDESKICOLLAPSELEVEL_HPP_ */
