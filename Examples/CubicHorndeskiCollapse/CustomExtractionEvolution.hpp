...
#ifndef CUSTOMEXTRACTIONEVOLUTION_HPP_
#define CUSTOMEXTRACTIONEVOLUTION_HPP_
...
class CustomExtractionEvolution
{
  private:
  ...
  public:
    //! The constructor
    CustomExtractionEvolution(int a_comp, int a_num_points, double a_L,
    ...
    //! Destructor
    ~CustomExtractionEvolution() {}

    //! Execute the query
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator,
                       std::string a_file_prefix) const
    {
        CH_TIME("CustomExtractionEvolution::execute_query");
...
#endif /* CUSTOMEXTRACTIONEVOLUTION_HPP_ */
